...
public class OculusHaptics : MonoBehaviour
{
    ...
    private OVRHapticsClip clipLight = null;
    private OVRHapticsClip clipMedium = null;
    private OVRHapticsClip clipHard = null;
    ...
    private void InitializeOVRHaptics()
    {
        ...
        for (int i = 0; i < cnt; ++i)
        {
            ...
            clipMedium.Samples[i] = i % 2 == 0 ? (byte)0 : (byte)180;
